...
export default function SubscriptionDashboard(props) {
    ...
    const [dashboardData, setDashboardData] = useState({
      ...
      const user_type_colors = ['#F98925', '#232529'];
    
    
      const plan_sold_color = ['#F98925', '#232529', '#A51854'];
    ...
    <div>
            <div className="row mt-5">
              ...
              <div className="col-sm-6 col-md-3 pb-3">
                ...
                <div className="p-3  top-card">
                  <p className='mb-1 font-1 macan-bold'>{dashboardData['new_subscriptions']}</p>
                  <p className='mb-1 font-2 macan-semibold'>Plan Purchased</p>
                  <div className='d-flex justify-content-end'>
              ...
              <div className="col-sm-6 col-md-3 pb-3">
                ...
                <div className=" p-3 top-card">
                  <div>
                    ...
                    {dashboardData.total_users >=0 && <span>
                    ...
                    </span>}
                    {
                      dashboardData.total_users <0 && <span>
                        <p className='mb-1 font-1 macan-bold'>{dashboardData['new_subscriptions']}</p>
                        <p className='mb-1 font-2 macan-semibold'>New Subscriptions</p>
                      </span>
                    }
              ...
              <div className="col-sm-4 dash  pb-3">
                <div className="dash-card h-100 p-3">
                  <div className="chart-title">
                    ...
                    <span className='px-1 font-2 macan-bold'>Users</span>
                  </div>
                  <div style={{ height: "90%" }}>
                    <CustomPieChart icon={pieIcon} data={dashboardData['user_status']} colors={user_type_colors} />
                ...
                <div className='dash-card h-100 p-3 perfomance-chart-div'>
                  <div className="h-100 perfomance-chart">
                    ...
                    <div style={{ height: "90%" }}>
                      ...
                      <CustomBarChart data={dashboardData['payment_earning']} />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-sm-4 dash pb-3">
                <div className="dash-card h-100 p-3 ">
                  <div className="chart-title">
                    ...
                    <span className='px-1 font-2 macan-bold'>Plan Sold</span>
                  </div>
                  <div style={{ height: "90%" }}>
                    <CustomPieChart icon={saleChannelPieIcon} data={dashboardData['plan']} colors={plan_sold_color} />
